  ...
  handleRenderWelcomeText() {
    return (
      <View style={tailwind('text-center p-2')}>
        <Label style={tailwind('text-primary text-lg font-bold text-center')}>Welcome To</Label>
        {/* <Label style={{ color: Colors.text_color_3, fontWeight: '900', fontSize: 20 }}>To</Label> */}
        <Label style={tailwind('text-primary text-2xl font-bold text-center')}>{`${AppConfig.app_display_name}`}</Label>
      </View>
    )
  }
