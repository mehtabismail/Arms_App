      ...
      result.then((res) => {
        if (res.result == 1) {
          ...
          if (error_msg == 'Data Not Found') {
            Alert.alert(
              'Process Failed',
              'Data not found. Please make sure your card no or NRIC is correct.',
              [{text: 'OK', style: 'cancel'}],
              {cancelable: false},
            );
          } else {
          ...
          <View style={{elevation: 20}}>
            <Card
              containerStyle={tailwind(
                'rounded-lg bg-white opacity-100 mt-16',
              )}>
              <ScrollView>
                {/* Content */}
                <KeyboardAvoidingView
                  ...
                  <View>
                    <View style={tailwind('mt-3 px-3')}>
                      <Text style={tailwind('text-base font-bold')}>
                        Please insert your Card No. or NRIC. Your first time
                        login password will be sent to your email.
                      </Text>
                    </View>
                  ...
                  <View style={tailwind('justify-center items-center')}>
                      ...
                      <View>
                        ...
                        <View
                          ...
                          <ARMSTextInput
                            ...
                            leftImageColor={
                              this.state.email_verify ? '' : Colors.text_color_2
                            }
                            borderColor={
                    ...
                    <OTPModal
                      ...
                      onClose={(res) => {
                        this.handleOTPModalVisibleOnChanged(false, res);
                      }}
