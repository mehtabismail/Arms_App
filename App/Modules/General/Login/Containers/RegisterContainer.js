    ...
    return (
      ...
      <SafeAreaView style={ApplicationStyles.screen.safeAreaContainer} forceInset={{ vertical: 'never' }} >
        ...
        <View style={tailwind("h-full w-full bg-gray-200 justify-center")}>
          <View>
            <ScrollView contentContainerStyle={{ justifyContent: "center", paddingVertical: 5 }}>
              {/* Content */}
              <KeyboardAvoidingView behavior="padding" enableKeyboardAvoiding={Platform.OS === "ios" ? true : false} >
                ...
                <View style={tailwind("mt-16 justify-center items-center")}>
                      ...
                      <View style={tailwind("flex-1")}>
                        ...
                        {/* Checking Email Format */}
                        {
                          (!this.state.initScreenEmail)
                            ...
                            :
                            <Text >{` `}</Text> // To maintain the space in screen.
                        }
                      </View>
                    </View>
                      ...
                      <View style={tailwind("self-center w-full mt-5 ")}>
                        <View style={{ elevation: 20 }}>
                          <Button
                            ...
                            onPress={
                              () => {this.handleRegistrationData(this.state.email, this.state.password, this.state.repassword)}
                            }
                          />
                        </View>
                      </View>
