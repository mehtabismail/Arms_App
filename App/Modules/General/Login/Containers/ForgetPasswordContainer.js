        ...
        if (res.result == 1) {
          ...
          if (error_msg == 'Data Not Found') {
            Alert.alert(
              ...
              'Data not found. Please make sure your card no and email are correct.',
              [{text: 'OK', style: 'cancel'}],
              {cancelable: false},
            );
          } else {
  ...
  render() {
    return (
      ...
      <SafeAreaView
        ...
        <View style={tailwind('h-full w-full justify-center bg-gray-200')}>
          <View style={tailwind('mt-16')}>
            <Card style={tailwind('bg-white rounded')}>
              <ScrollView>
                {/* Content */}
                <KeyboardAvoidingView
                  behavior="padding"
                  ...
                  <View>
                    <View style={tailwind('mt-3 px-3')}>
                      <Text style={tailwind('text-base font-bold')}>
                        To reset your password, please insert your card no. and
                        email. Your temporary password will be sent to your
                        email.
                      </Text>
                    </View>
                    <View style={tailwind('mt-3 p-3 mb-5')}>
                      <Text style={tailwind('text-base')}>
                        *Please check the spam folder if you do not receive the
                        email.
                      </Text>
                    </View>
                  </View>
                  ...
                  <View style={tailwind('justify-center items-center')}>
                    ...
                    <View
                      style={tailwind(
                        'w-11/12 justify-center items-center flex-row my-3',
                      )}>
                      ...
                      <View style={tailwind('flex-1')}>
                        <Input
                          ...
                          autoCorrect={false}
                          onChangeText={(value) => {
                            this.setState({nric: value, initScreenNric: false});
                          }}
                          onEndEditing={() => {
                            this.onCheckNric(this.state.nric.length);
                          }}
                    ...
                    <View
                      ...
                      <View style={tailwind('flex-1')}>
                        <Input
                          ...
                          onEndEditing={() => {
                            this.onCheckEmail(this.state.email.length);
                          }}
